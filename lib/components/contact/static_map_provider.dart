import 'package:moodowon_orebro/components/contact/location.dart';
...
class StaticMapProvider {
  ...
  Uri getStaticUriWithMarkers(List<Marker> markers, int zoomLevel, {int width, int height}) {
    return _buildUrl(markers, null, zoomLevel, width ?? defaultWidth, height ?? defaultHeight);
  }

  Uri _buildUrl(List<Marker> locations, Location center, int zoomLevel, int width, int height) {
